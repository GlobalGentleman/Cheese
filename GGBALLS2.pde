...
File scores = dataFile("C:/Users/rikuk/Desktop/GGBALLS2/scores.txt");
boolean exist = scores.isFile();
...
void setup() {
  ...
  if (exist)
  {
    ...
    print("tehrää uus");
    highscore = createWriter("scores.txt");
  }
  gameScreen=0;
}
...
void initScreen()
{
  ...
  text("Jos painat ohi menetät 1 hp:n, jos hp putoaa nollaan häviät pelin", height/2, width/2-60);
